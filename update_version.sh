...
## CONFIG                                                                     ##
################################################################################
PROJECT_NAME_ORIGINAL=$(basename $(git config --get remote.origin.url) .git);
PROJECT_NAME=$(echo $PROJECT_NAME_ORIGINAL | tr [:lower:] [:upper:] );
HEADER_FILE=./include/${PROJECT_NAME_ORIGINAL}_Utils.h
DOXY_FILE=Doxyfile
